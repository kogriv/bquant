...
was not activated, a Windows shell, a container. Until this module existed it exited
with rc 1 and a ``No module named bquant.__main__`` message, which reads as "the package
is broken" rather than "that form is not supported".
