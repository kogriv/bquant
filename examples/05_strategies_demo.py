    ...
    indicators_to_test = [
        ...
        },
        {
            ...
            "detection": {
                ...
                "upper_threshold": 60,
                "lower_threshold": 40,
                # `require_cross` отсюда убран: такого правила у стратегии
                # `threshold` нет и никогда не было — его никто не читал, и
                # пример молча передавал его в пустоту. Поймано проверкой
                # незнакомых правил (G29) на первом же прогоне примеров.
            },
        },
    ]
