...
**Родитель:** `devref/cleanup/oss_readiness_plan_2026-07.md` (Батч D, шаг D0) — **закрыт**;
этот документ остаётся снимком организации `docs/` на 2026-07-22. С тех пор по докам прошёл
последовательный проход из пяти волн (`../architecture/docs_sequential_pass_2026-08.md`,
54 страницы, закрыт 2026-09-05), так что карта ниже описывает прежнюю структуру.
