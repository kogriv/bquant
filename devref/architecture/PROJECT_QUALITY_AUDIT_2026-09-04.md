...
| 5. Усилить доказательства | CI-матрица, property-based инварианты, edge-cases | ⏸️ **отложен решением владельца 2026-09-07** — см. ниже |
...
Property-based инварианты и явные edge-cases (пустой кадр, дубли, перекрытия, таймзоны,
константный ряд) остаются несделанными и от решения про CI не зависят — это отдельный,
более дешёвый кандидат в работу.
