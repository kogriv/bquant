...
|---|---|---:|---|
| G49 | pandas 3 compatibility и dependency matrix | P0 | AQ-008 |
| G50 | Cache dependency coverage и immutable execution config | P0 | AQ-001, AQ-002, AQ-051 |
| G51 | Causal parity global/per-zone swings | P0 | AQ-003, AQ-004 |
| G52 | Validation semantics и pipeline wiring | P0/P1 | AQ-005–AQ-009 |
| G53 | Lossless result persistence | P1 | AQ-010, AQ-011 |
| G54 | Data contracts и validation consistency | P1 | AQ-014–AQ-020, AQ-024–AQ-026 |
| G55 | Indicator implementation parity | P1 | AQ-021–AQ-023, AQ-028 |
| G56 | Public analyzer API honesty | P2 | AQ-031, AQ-032 |
