...
- Покрыты все 33 кодовых блока из руководства: от runtime-примеров до bash-команд, структуры пакета и setup.py.
...
- Перенесли все кодовые блоки в тест `devref/gaps/zo/zodoctest/test_extension_guide_validation.py`, добавив динамический пакет `my_bquant_extension` и проверку каждого сценария (индикаторы, анализаторы, стратегии, визуализации, загрузчики, pytest-сниппеты, CLI, packaging).
- Реализовали контроль покрытия: тест формирует множество из индексов всех блоков и валидирует, что закрыто 33/33 примеров.
...
-**Статус:** 🟢 ✅ ВАЛИДИРОВАН (33/33 кодовых блоков покрыты)
- 📄 Скрипт: `python -m pytest devref/gaps/zo/zodoctest/test_extension_guide_validation.py`
