...
Содержание:
1. Почему ушли от MACD-specific класса (исторический контекст; класс удалён в 0.0.5)
...
nb.info("Раньше был класс MACDZoneAnalyzer — удалён в 0.0.5 (был deprecated с v2.1).")
