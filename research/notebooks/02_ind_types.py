...
nb.info("[OK] Единообразный интерфейс для всех типов индикаторов")
nb.info("[OK] Гибкость в выборе источника данных (PRELOADED, LIBRARY, CUSTOM)")
nb.info("[OK] Универсальную фабрику для создания индикаторов")
nb.info("[OK] Совместимость с существующим кодом")
nb.info("[OK] Расширяемость для новых типов индикаторов")
