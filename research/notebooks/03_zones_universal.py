...
nb.log("")
nb.log("=" * 70)
nb.log("СТАРЫЙ КОД (removed in 0.0.5 — для справки, если мигрируете со старого):")
nb.log("=" * 70)
nb.log("""
from bquant.indicators.macd import MACDZoneAnalyzer   # removed in 0.0.5
...
nb.log("  [-] Старый API удалён — мигрировать обязательно")
