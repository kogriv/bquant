...
**Legacy-имена (экспортируются и работают, но предпочтителен пайплайн):**
...
Слова «deprecated» здесь нет намеренно: **в коде нет ни предупреждения, ни маркера
устаревания**, и по конвенции проекта переходных механизмов не заводят. Пока имя
экспортируется и работает — честнее назвать его legacy, чем объявлять устаревшим
и ничего за этим не иметь.
