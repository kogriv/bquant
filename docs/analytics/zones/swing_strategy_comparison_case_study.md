...
> **Поправка от 2026-08-31 — прочтите до выводов.** Нули у `find_peaks` и `pivot_points`
> в этом отчёте — свойство **одной строки конфигурации**, а не свойство стратегий. Все
> прогоны здесь сделаны с `with_auto_swing_thresholds(True)`, а этот режим поднимает
> `min_amplitude_pct` выше размаха типичной зоны. Без него обе стратегии работают:
>
...
> основанием выбора стратегии там, где основанием быть не могла. Причина обнуления —
> дефект пакета, а не нехватка тюнинга:
> `devref/gaps/swing/g38_adaptive_thresholds_restore_the_threshold_g35_removed_2026-08.md`.
> Числа ниже оставлены как есть: это измерение, и для своей конфигурации оно верно.
